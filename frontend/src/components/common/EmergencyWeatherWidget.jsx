...
export default function EmergencyWeatherWidget() {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-slate-900/5 border border-orange-200/70 rounded-3xl p-5 shadow-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-xl font-extrabold text-slate-900">31°C</span>
              <span className="text-xs font-semibold text-slate-600">Sunny & Breezy</span>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold transition-all shadow-sm cursor-pointer ml-auto"
        >
