  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">System Settings & Configurations</h2>
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-sm shadow-emerald-600/20 flex items-center gap-1.5 transition-all disabled:opacity-50"
        >
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all ${
                isActive
                  ? 'bg-slate-100 text-slate-900 border border-slate-200 shadow-md'
      ...
      <form onSubmit={handleSave} className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-5">
        ...
        {activeTab === 'general' && (
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-900 mb-3">General Platform Information</h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pb-4 border-b border-slate-200">
              {/* Site Logo */}
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-2">Website Logo</label>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    <input
                      ...
                      className="block w-full text-xs text-slate-400 file:mr-4 file:py-1.5 file:px-3 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-emerald-50 file:text-emerald-500 hover:file:bg-emerald-500/20 transition-all"
                    />
                    <input
                      type="text"
                      ...
                      className="w-full px-3 py-1.5 bg-slate-100 border border-slate-200 rounded-lg text-xs text-slate-900 placeholder-slate-500"
                    />
                  </div>
                </div>
              </div>
              ...
              {/* Site Banner */}
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-2">Website Banner</label>
                <div className="flex items-start gap-4">
                  <div className="w-24 h-16 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden shrink-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Platform Brand Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">English Headline</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Customer Support Phone</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Default Display Currency</label>
                <select
              ...
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Exchange Rate (1 USD to KHR)</label>
                <input
                  type="number"
        ...
        {activeTab === 'social' && (
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-900 mb-3">Official Social Media & Community Links</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Facebook Page</label>
                <input
                  type="url"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">Telegram Community</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">TikTok Account</label>
                <input
                  type="url"
        ...
        {activeTab === 'email' && (
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-900 mb-3">SMTP Mail Server Configuration</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
        ...
        {activeTab === 'maintenance' && (
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-900 mb-3">Platform Maintenance Safeguard</h3>
            ...
            <div className="flex items-center gap-3 pt-2">
              <label className="flex items-center gap-2 cursor-pointer text-xs font-bold text-slate-900">
                <input
                  ...
                  className="w-5 h-5 rounded border-slate-200 text-emerald-600 bg-slate-100"
                />
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">Maintenance Banner Message</label>
              <textarea
                rows={3}
